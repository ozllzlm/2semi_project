         ...
         <div class="board_area">
            ...
            <div class="board_content">
               ...
               <div>
                  ...
                  <c:if test="${ likeBid == board.bid }">
                  <a href="#"><img class="good" src="${ contextPath }/resources/images/infogood.png" onclick="location.href='${contextPath}/myscrap/delete?bid=${board.bid }'"></a>
                  </c:if>
                     ...
                     <c:forEach items="${ board.replyList }" var="reply">
                        <ul class="reply_ul">
                           ...
                           <li class="Rshow" onclick="Rshow('${ reply.nickName}','${reply.acontent }',${ reply.aid },${ reply.writer });">
                                 <img class="replyimg" 
                                    src="${contextPath }/resources/images/siren2.png"> 
                                   </li> 
                           <!-- 댓글 삭제 -->                           
